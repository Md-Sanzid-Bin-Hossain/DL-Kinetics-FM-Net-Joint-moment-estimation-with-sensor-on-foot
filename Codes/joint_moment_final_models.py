...
train_dataset_treadmill=np.concatenate((subject_7_treadmill,subject_8_treadmill,subject_9_treadmill,subject_10_treadmill,
                              subject_11_treadmill,subject_12_treadmill,subject_14_treadmill,subject_15_treadmill,\
...
train_dataset_levelground=np.concatenate((subject_7_levelground,subject_8_levelground,subject_9_levelground,subject_10_levelground,
                              subject_11_levelground,subject_12_levelground,subject_14_levelground,subject_15_levelground,\
...
train_dataset_ramp=np.concatenate((subject_7_ramp,subject_8_ramp,subject_9_ramp,subject_10_ramp,
                              subject_11_ramp,subject_12_ramp,subject_14_ramp,subject_15_ramp,\
...
train_dataset_stair=np.concatenate((subject_7_stair,subject_8_stair,subject_9_stair,subject_10_stair,
                              subject_11_stair,subject_12_stair,subject_14_stair,subject_15_stair,\
...
test_dataset=np.concatenate((subject_13_treadmill,subject_13_levelground,subject_13_ramp,subject_13_stair),axis=0)
...
#import os 
# 
#main_dir = "/home/sanzidpr/Chase_conference/Subject14"
#os.mkdir(main_dir) 
#
#path='/home/sanzidpr/Chase_conference/Subject14/'
...
#  Model_1=Dropout(0.3)(model_1)
  ...
  output_GRU_1=Dense(64,activation='relu')(output_GRU)
  ...
  output_C2_1=Dense(64,activation='relu')(output_C2)
  ...
  output_C1_1=Dense(64,activation='relu')(output_C1)
