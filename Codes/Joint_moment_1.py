...
train_dataset_treadmill=np.concatenate((subject_8_treadmill,subject_9_treadmill,subject_10_treadmill,subject_11_treadmill,subject_12_treadmill,
                              ...
                              subject_23_treadmill,subject_24_treadmill,subject_25_treadmill,subject_27_treadmill,subject_28_treadmill,subject_30_treadmill),axis=0)


train_dataset_levelground=np.concatenate((subject_8_levelground,subject_9_levelground,subject_10_levelground,subject_11_levelground,subject_12_levelground,
                              ...
                              subject_23_levelground,subject_24_levelground,subject_25_levelground,subject_27_levelground,subject_28_levelground,subject_30_levelground),axis=0)


train_dataset_ramp=np.concatenate((subject_8_ramp,subject_9_ramp,subject_10_ramp,subject_11_ramp,subject_12_ramp,
                              ...
                              subject_23_ramp,subject_24_ramp,subject_25_ramp,subject_27_ramp,subject_28_ramp,subject_30_ramp),axis=0)


train_dataset_stair=np.concatenate((subject_8_stair,subject_9_stair,subject_10_stair,subject_11_stair,subject_12_stair,
                              ...
                              subject_23_stair,subject_24_stair,subject_25_stair,subject_27_stair,subject_28_stair,subject_30_stair),axis=0)
...
test_dataset=np.concatenate((subject_7_treadmill,subject_7_levelground,subject_7_ramp,subject_7_stair),axis=0)


import os 
 
main_dir = "/home/sanzidpr/Chase_conference_2/Subject07"
os.mkdir(main_dir) 

path='/home/sanzidpr/Chase_conference_2/Subject07/'
...
#  Model_1=Dropout(0.3)(model_1)
  ...
  output_GRU_f=Flatten()(output_GRU)
  output_C2_f=Flatten()(output_C2)
  output_C1_f=Flatten()(output_C1)
  
  output_GRU_1=Dense(128,activation='relu')(output_GRU_f)
  #output_GRU_1=GRU(64,return_sequences=True)(output_GRU)
  ...
  output_C2_1=Dense(128,activation='relu')(output_C2_f)
  #output_C2_1=GRU(64,return_sequences=True)(output_C2)
  ...
  output_C1_1=Dense(128,activation='relu')(output_C1_f)
  #output_C1_1=GRU(64,return_sequences=True)(output_C1)
...
savetxt(path+'FM_results.csv', ablation_11, delimiter=',')
...
#
#
## output_rmse_1=Dense(128,activation='relu')(output_rmse)
## output_pcc_1=Dense(128,activation='relu')(output_pcc)
## Feat_1=concatenate([output_rmse_1,output_pcc_1])
#
#output_gain=GRU(128,return_sequences=True)(Feat_1)
#output_gain=Dense(3,activation='sigmoid')(output_gain)
#
## output_rmse_2=Dense(128,activation='relu')(output_rmse)
## output_pcc_2=Dense(128,activation='relu')(output_pcc)
...
#Feat_2=concatenate([output_rmse_2,output_pcc_2])
#
##output_offset=Dense(128,activation='relu')(Feat_2)
...
#
#model_1 = Model(inputs=[inputs_1D, inputs_2D], outputs={'rmse_1':output_1,'rmse_2':output_2,'rmse_3':output_3,'rmse_4':output_rmse,'pcc_1':output_4,\
#                                                        'pcc_2':output_5,'pcc_3':output_6,'pcc_4':output_pcc,'rmse_main':output})
#
#losses = {
#	'rmse_1': correlation_coefficient_loss_1,'rmse_2': correlation_coefficient_loss_1,'rmse_3': correlation_coefficient_loss_1,'rmse_4': correlation_coefficient_loss_1,
#	'pcc_1': correlation_coefficient_loss,'pcc_2': correlation_coefficient_loss,'pcc_3': correlation_coefficient_loss,'pcc_4': correlation_coefficient_loss,\
#	'rmse_main': correlation_coefficient_loss_1
#}
#
#
#
#opt = tf.keras.optimizers.Adam(learning_rate=3e-4)
#model_1.compile(loss=losses, optimizer=opt)
#
#
#model_1.summary()
#
#
#history=model_1.fit([train_X_1D,train_X_2D], {'rmse_1':train_y_5,'rmse_2':train_y_5,'rmse_3':train_y_5,'rmse_4':train_y_5,'pcc_1':train_y_5,'pcc_2':train_y_5,\
#                                              'pcc_3':train_y_5,'pcc_4':train_y_5,'rmse_main':train_y_5}, epochs=40, batch_size=64, validation_data=([X_validation_1D,X_validation_2D], {'rmse_1':Y_validation,'rmse_2':Y_validation,'rmse_3':Y_validation,'rmse_4':Y_validation,'pcc_1':Y_validation,'pcc_2':Y_validation,'pcc_3':Y_validation,'pcc_4':Y_validation,'rmse_main':Y_validation}), verbose=2, shuffle=False)
#
#
#
#
...
All_result=np.vstack([ablation_1,ablation_2,ablation_3,ablation_4,ablation_5,ablation_6,ablation_7,ablation_8,ablation_9,ablation_10])
